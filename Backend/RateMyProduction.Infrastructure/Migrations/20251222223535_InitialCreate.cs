        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Username1 = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Email = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    PasswordHash = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    DisplayName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    PrimaryRole = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleWorked = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_Productions_ProductionID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Productions_Studio",
                table: "Productions",
                column: "Studio");

            migrationBuilder.CreateIndex(
                name: "IX_Productions_Title",
                table: "Productions",
                column: "Title");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_ProductionID_DatePosted",
                table: "Reviews",
                columns: new[] { "ProductionID", "DatePosted" });
